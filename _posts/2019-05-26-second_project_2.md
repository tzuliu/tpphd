...
<!--![conjoint estimates]({{ "/assets/minister.png" | relative_url }}){: height="250px" width="350px"}{: .align-center}-->
![conjoint estimates]({{ site.url }}{{ site.baseurl }}/assets/minister.png-250x350.jpg){: .align-center}
